...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    " highlight groups
    call <SID>X("Cursor", "ffffff", "110055", "")
    "CursorIM
    "Directory
    "DiffAdd
    "DiffChange
    ...
    call <SID>X("NonText", "ffffff", "000000", "bold")
    call <SID>X("Question", "ffffff", "", "")
    call <SID>X("Search", "ffffff", "cd853f", "")
    call <SID>X("SpecialKey", "ffffff", "", "")
    call <SID>X("StatusLine", "ffffff", "000000", "reverse")
    call <SID>X("StatusLineNC", "ffffff", "7f7f7f", "reverse")
    call <SID>X("Title", "ffffff", "", "")
    call <SID>X("Visual", "ffffff", "f0e68c", "reverse")
    "VisualNOS
    ...
    call <SID>X("Comment", "aaffcc", "", "")
    call <SID>X("Constant", "ffa0a0", "", "")
    call <SID>X("Identifier", "ccfbcc", "", "none")
    call <SID>X("Statement", "f0e68c", "", "bold")
    call <SID>X("PreProc", "fd5c5c", "", "")
    call <SID>X("Type", "fdf7bb", "", "bold")
    ...
    hi IncSearch     cterm=NONE ctermfg=yellow ctermbg=NONE
...
hi LineNr cterm=NONE ctermbg=NONE ctermfg=lightcyan
hi CursorLineNr cterm=NONE ctermbg=NONE ctermfg=red
hi CursorLine   cterm=NONE ctermbg=black ctermfg=NONE guibg=darkred guifg=lightred
hi CursorColumn cterm=NONE ctermbg=darkgrey ctermfg=NONE guibg=darkred guifg=lightred
